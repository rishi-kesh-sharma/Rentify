...
import Rent from '../containers/Admin/Rent';
import RentAddEdit from '../containers/Admin/Rent/AddEditPage/index';
import RentCategory from '../containers/Admin/RentCategory';
import RentCategoryAddEdit from '../containers/Admin/RentCategory/AddEdit/index';
import RentSubCategory from '../containers/Admin/RentSubCategory';
import RentSubCategoryAddEdit from '../containers/Admin/RentSubCategory/AddEdit/index';
...
const adminRoutes = [
  ...
  {
    exact: true,
    path: 'rent-manage/add',
    element: <RentAddEdit />,
  },
  {
    exact: true,
    path: 'rent-manage/edit/:id',
    element: <RentAddEdit />,
  },
  {
    exact: true,
    path: 'rent-cat-manage',
    element: <RentCategory />,
  },
  {
    exact: true,
    path: 'rent-cat-manage/add',
    element: <RentCategoryAddEdit />,
  },
  {
    exact: true,
    path: 'rent-cat-manage/edit/:id',
    element: <RentCategoryAddEdit />,
  },

  {
    exact: true,
    path: 'rent-sub-cat-manage',
    element: <RentSubCategory />,
  },
  {
    exact: true,
    path: 'rent-sub-cat-manage/add',
    element: <RentSubCategoryAddEdit />,
  },
  {
    exact: true,
    path: 'rent-sub-cat-manage/edit/:id',
    element: <RentSubCategoryAddEdit />,
  },
  {
    exact: true,
