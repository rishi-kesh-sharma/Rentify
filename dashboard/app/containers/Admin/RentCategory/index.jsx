...
const key = 'RentCategory';

/* eslint-disable react/prefer-stateless-function */
const RentCategory = (props) => {
  const {
  ...
  const handleEdit = (id) => {
    navigate(`/admin/rent-cat-manage/edit/${id}`);
  };
  ...
  const handleAdd = () => {
    props.clearOne();
    navigate('/admin/rent-cat-manage/add');
  };
...
export default connect(mapStateToProps, mapDispatchToProps)(RentCategory);
