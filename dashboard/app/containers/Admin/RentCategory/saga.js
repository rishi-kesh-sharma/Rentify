...
function* redirectOnSuccess() {
  ...
  yield put(push('/admin/rent-cat-manage'));
}
...
function* deleteSuccessFunc(action) {
  const snackbarData = {
    message: action.payload.msg || 'Rent Category delete success!!',
    options: {
      variant: 'success',
    },
  };
...
function* getCount(action) {
  ...
  yield call(
    Api.get(
      `rent/count/category/${action.payload}`,
