...
function* redirectOnSuccess() {
  ...
  yield put(push('/admin/rent-manage'));
}
...
function* deleteSuccessFunc(action) {
  const snackbarData = {
    message: action.payload.msg || 'rent delete success!!',
    options: {
      variant: 'success',
    },
  };
...
export default function* defaultSaga() {
  ...
  yield takeLatest(types.DELETE_ONE_REQUEST, deleteRent);
