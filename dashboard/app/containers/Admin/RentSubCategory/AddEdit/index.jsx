...
const AddEdit = (props) => {
  ...
  const { one, loading, errors, category } = props;
  ...
  const handleBack = () => {
    navigate('/admin/rent-sub-cat-manage');
  };
  ...
  return loading && loading == true ? (
    ...
    <div>
      <Helmet>
        <title>
          {routeID ? 'Edit Rent Sub Category' : 'Add Rent Sub Category'}
        </title>
      </Helmet>
      <PageHeader
        title={routeID ? 'Edit Rent Sub Category' : 'Add Rent Sub Category'}
        back="/admin/rent-sub-cat-manage"
        actions={
          <>
